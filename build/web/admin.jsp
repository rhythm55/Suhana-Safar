...
<form name="ff" type="post" action="adminlogincheck.jsp">
 <table bgcolor='black' class=fcolor border="1" bordercolor="skyblue" cellspacing=4 width="1200">
        
            <tr>
                <td  class="gtext" colspan="2" align="center">
                    <div class="content">
                    <div><center><img src="logos/Adminlogo.png" width="150" height="40" alt=""/></center></div>
                </td>
            </tr>
            <tr>
                <td width="700">
            <center><img src="bg2.jpg" width="500" height="400"></center>
                </td>
                <td>
