<html>
    ...
    <head>
        <title>SUAHANA SAFAR HOTELS</title>
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <style>
			...
			body{
				background:#333 url(hotel.jpg) repeat top left;
				font-family:Arial;
                                margin-left: 100px
			}
			span.reference{
				...
				font-size:12px;
                        ...
                        span.ref{background-color: black;
				position:fixed;
				right:200px;
				bottom:10px;
				font-size:12px;
...
<table bgcolor='black' border="1" bordercolor="skyblue" cellspacing=4 width="1200">
            <tr>
                <td  class="gtext" colspan="3" align="center" >
                    <div class="content">
                    <div><center><img src="logos/hotelslogo.png" width="100" height="40" alt=""/></center></div>
                </td>
            </tr>
            <tr>
