  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <style>
			...
			body{
				background:#333 url(bg8.jpeg) repeat top left;
				font-family:Arial;
                                margin-left: 100px
			}
			span.reference{
...
<tr>
    <td>
       ...
       <table border="1" bgcolor='black' bordercolor="skyblue" cellspacing=4 width="1200">
          
            <tr>
                <td  class= "gtext" colspan="2" align="center">
                    <div class="content">
                    <div><center><img src="logos/Packageslogo.png" width="100" height="40" alt=""/></center></div>
                </td>
            </tr>
            <tr>
