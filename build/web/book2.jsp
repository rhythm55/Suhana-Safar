...
<table border="1" bordercolor="skyblue" cellspacing=4 width="1500" height="500">
            <tr>
                <td colspan="2" align="center" width="1200">
                 ...
                 <tr>
                <td width="800">
            <center><img src="images/c.jpg" width=800></center>
                </td>
                
                <td><center><table class=fcolor cellspacing="30">
                    <tr>
                        <td> 
                            <% String s=request.getParameter("a");
                                session.setAttribute("packagen",s);
                            %>
                            selected package:</td><td><input type="text" name="t1" value='<%out.print(session.getAttribute("packagen"));%>' read only />
             </td>
             </tr>
            <tr>
             <td>
