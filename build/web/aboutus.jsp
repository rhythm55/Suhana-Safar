  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <style>
			...
			body{
				background:#333 url(mybg.jpg) repeat top left;
				font-family:Arial;
...
<table border="1" class='fcolor' bgcolor=black bordercolor="skyblue" cellspacing=4 vspace="0" width="1500">
            <tr  align="left">
                <td  class="gtext" colspan="2" align="center">
                    <div class="content">
                    <div><center><img src="logos/Aboutlogo.png" width="100" height="40" alt=""/></center></div>
                </td>
            </tr>
            <tr>
                <td width="800">
            <center><img src="mybg.jpg" width="800" height="400"></center>
                </td>
                <td>
                   
                    <font size='5'>  we offer a variety of treks and tour packages in India with exotic adventurous designed tours to appeal to most visitor's budget ,due to our many years of experience in travel industry. we can offer unbeatable price with no compromise on quality.   
                    </font></td>
    </tr></table>
